  ...
  return (
    <div
      className={`
        ...
        ${open ? "border-[var(--neon-green)] shadow-[0_0_15px_rgba(57,255,20,0.2)]" : ""}
      `}
    >
      <button
        ...
        className={`
          ...
          hover:text-[var(--neon-green)]
        `}
      >
        {question}
        <span className="text-[var(--neon-green)] text-2xl">
          {open ? "−" : "+"}
        </span>
      </button>
...
>
  <div className="container mx-auto pb-4">
      ...
      >
        ...
        <button
          className="
            ...
            before:left-[-100%] before:w-full before:h-full
    ...
    >
      <i
        className="
          fas fa-shield-alt text-[var(--neon-green)]
  ...
  <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 max-w-[1200px] mx-auto relative z-[1]">
    ...
    {/* Service Card 1 */}
    <div className="group bg-[rgba(18,18,18,0.8)] p-10 rounded-lg text-center transition-all duration-300 border border-[rgba(57,255,20,0.1)] relative overflow-hidden hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(57,255,20,0.1)] hover:border-[var(--neon-green)]">
      <span className="w-20 h-20 bg-[rgba(57,255,20,0.1)] rounded-full flex items-center justify-center text-[2rem] text-[var(--neon-green)] mb-6 border-2 border-[var(--neon-green)] shadow-[0_0_15px_rgba(57,255,20,0.2)] transition-all duration-300 group-hover:bg-[var(--neon-green)] group-hover:text-black group-hover:rotate-y-180 icon-float-1">
        <i className="fa-solid fa-file-alt"></i>
      </span>

      <h4 className="text-white text-[1.5rem] font-semibold mb-4 relative inline-block after:content-[''] after:absolute after:bottom-[-8px] after:left-1/2 after:-translate-x-1/2 after:w-[40px] after:h-[2px] after:bg-[var(--neon-green)] after:shadow-[0_0_8px_var(--neon-green)] after:transition-all group-hover:after:w-[80px]">
  ...
  <div className="max-w-[1200px] mx-auto relative z-[1]">
    ...
    {/* Title */}
    <h2 className="relative text-center text-[2.5rem] mb-12 text-[var(--neon-green)] shadow-neon inline-block left-1/2 -translate-x-1/2 after:content-[''] after:absolute after:bottom-[-10px] after:left-1/2 after:-translate-x-1/2 after:w-[80px] after:h-[2px] after:bg-[var(--neon-green)] after:shadow-[0_0_10px_var(--neon-green)]">
      What Our Users Say
    </h2>
    ...
    <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 mb-16">
      ...
      {/* Card 1 */}
      <div className="group testimonial-card bg-[rgba(18,18,18,0.8)] p-8 rounded-lg border border-[rgba(57,255,20,0.1)] relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(57,255,20,0.1)] hover:border-[var(--neon-green)]">
    ...
    {/* Partners Title */}
    <h2 className="partners-title relative text-center text-[2.5rem] mb-12 text-[var(--neon-green)] shadow-neon inline-block left-1/2 -translate-x-1/2 after:content-[''] after:absolute after:bottom-[-10px] after:left-1/2 after:-translate-x-1/2 after:w-[80px] after:h-[2px] after:bg-[var(--neon-green)] after:shadow-[0_0_10px_var(--neon-green)]">
      Premium Partners
    </h2>
...
>
    ...
    <section className="bg-black py-24 px-[5%] border-t border-[rgba(57,255,20,0.2)] relative overflow-hidden">
      <h2 className="text-[var(--neon-green)] text-4xl md:text-5xl text-center mb-12 relative inline-block left-1/2 -translate-x-1/2 drop-shadow-[0_0_10px_rgba(57,255,20,0.3)]">
        Frequently Asked Questions
        <span className="absolute bottom-[-10px] left-1/2 -translate-x-1/2 w-20 h-[2px] bg-[var(--neon-green)] drop-shadow-[0_0_10px_var(--neon-green)]"></span>
      </h2>
  ...
  <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--neon-green)] to-transparent"></div>

  <div className="max-w-[1200px] mx-auto grid gap-10 md:grid-cols-2 lg:grid-cols-4">
    <div className="footer-about">
      <div className="flex items-center gap-2 text-[var(--neon-green)] font-bold text-xl mb-4 drop-shadow-[0_0_10px_rgba(57,255,20,0.5)]">
      ...
      <div className="flex justify-center gap-6 mt-4">
        <a href="#" className="text-[#b3b3b3] hover:text-[var(--neon-green)] transition-all duration-300 text-xl"><i className="fab fa-facebook-f"></i></a>
        <a href="#" className="text-[#b3b3b3] hover:text-[var(--neon-green)] transition-all duration-300 text-xl"><i className="fab fa-twitter"></i></a>
        <a href="#" className="text-[#b3b3b3] hover:text-[var(--neon-green)] transition-all duration-300 text-xl"><i className="fab fa-instagram"></i></a>
        <a href="#" className="text-[#b3b3b3] hover:text-[var(--neon-green)] transition-all duration-300 text-xl"><i className="fab fa-linkedin-in"></i></a>
      </div>
    </div>

    <div className="footer-links">
      <h3 className="text-[var(--neon-green)] uppercase tracking-wider mb-4 relative inline-block">
        Quick Links
        <span className="absolute bottom-0 left-0 w-10 h-[2px] bg-[var(--neon-green)] drop-shadow-[0_0_5px_var(--neon-green)]"></span>
      </h3>
      <ul className="list-none p-0 m-0">
        {["Home", "Car History", "Car Report", "Dealer Pricing", "About Us", "Contact"].map((link, idx) => (
          <li key={idx} className="mb-2">
            <a href="#" className="relative pl-5 text-[#b3b3b3] hover:text-[var(--neon-green)] hover:pl-8 transition-all duration-300">
              <span className="absolute left-0 opacity-0 text-[var(--neon-green)] transition-all duration-300">→</span>
              {link}
            </a>
          </li>
        ))}
    ...
    <div className="footer-contact">
      ...
      <div className="flex items-start gap-2 text-[#b3b3b3] mb-2"><i className="fas fa-map-marker-alt text-[var(--neon-green)] mt-1"></i><span>123 Auto Street, Motor City, MC 12345</span></div>
      <div className="flex items-start gap-2 text-[#b3b3b3] mb-2"><i className="fas fa-phone-alt text-[var(--neon-green)] mt-1"></i><span>+1 (555) 123-4567</span></div>
      <div className="flex items-start gap-2 text-[#b3b3b3] mb-2"><i className="fas fa-envelope text-[var(--neon-green)] mt-1"></i><span>info@digitalworthyreports.com</span></div>
    </div>
    ...
    <div className="footer-newsletter">
      ...
      <form className="flex gap-2 flex-col sm:flex-row mt-4">
        <input type="email" placeholder="Your email address" required className="flex-1 px-4 py-2 rounded-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] text-white focus:outline-none focus:border-[var(--neon-green)] focus:shadow-[0_0_10px_rgba(57,255,20,0.3)]"/>
        <button type="submit" className="bg-[var(--neon-green)] text-black px-4 py-2 rounded-full font-semibold uppercase text-xs tracking-wide hover:bg-[#3ae60d] hover:shadow-[0_0_15px_rgba(57,255,20,0.5)] hover:-translate-y-1 transition-all">Subscribe</button>
      </form>
    </div>
  </div>

  <div className="mt-16 pt-8 border-t border-[rgba(255,255,255,0.1)] text-center text-gray-500 text-sm">
    &copy; 2023 DigitalWorthyReports. All rights reserved. | <a href="#" className="hover:text-[var(--neon-green)]">Privacy Policy</a> | <a href="#" className="hover:text-[var(--neon-green)]">Terms of Service</a>
  </div>
</footer>
