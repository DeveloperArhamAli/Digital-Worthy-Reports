...
import { Shield, AlertTriangle, CheckCircle, Car } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-gray-800/50 p-4 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-gray-400">Last Odometer</span>
          </div>
          <div className="text-2xl font-bold text-white">
            {preview.previewData.lastOdometer}
          </div>
        </div>
        ...
        <div className="bg-gray-800/50 p-4 rounded-xl">
          ...
          <div className="text-2xl font-bold text-white">
            {preview.previewData.titleStatus}
          </div>
        </div>
      </div>
